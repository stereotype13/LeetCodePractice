...
int main(int argc, const char* argv[]) {
	...
	cout << solution.findPairs(vec1, 2) << endl;

	vector<int> vec2{ 1, 2, 3, 4, 5 };
	cout << solution.findPairs(vec2, 1) << endl;

	vector<int> vec3{ 1, 3, 1, 5, 4 };
	cout << solution.findPairs(vec3, 0) << endl;

	vector<int> vec4{ 1, 2, 3, 4, 5 };
	cout << solution.findPairs(vec4, -1) << endl;

	vector<int> vec5{ 1, 1, 1, 2, 1 };
	cout << solution.findPairs(vec5, 1) << endl; //1
