...
int main(int argc, const char* argv[]) {
	...
	vector<int> recA1{ 0, 0, 2, 2 }, recB1{ 1, 1, 3, 3 };
	cout << boolalpha << solution.isRectangleOverlap(recA1, recB1) << endl;

	vector<int> recA2{ 0, 0, 1, 1 }, recB2{ 1, 0, 2, 1 };
	cout << boolalpha << solution.isRectangleOverlap(recA2, recB2) << endl;
